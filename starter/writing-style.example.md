...
## Diction & rhythm
- Sentence length: varied — short when making the point, longer when building to it.
- Formality default: warm and direct. Professional, not stiff.
- Contractions: yes, always.
- Punctuation habits: spaced hyphen ( - ), never an em-dash. One exclamation mark per message, max.

## Do
- Say the honest thing, including the part that isn't flattering to me.
- Open with the point. No throat-clearing.
- Concrete nouns and real numbers over adjectives. "Signups went 31 to 45" beats "significantly improved."
- One dry aside per message. Never two - it starts to read as a bit.

## Don't (AI tells to strip)
- Banned: leverage, delve, robust, seamless, spearhead, "thrilled to", "I'm excited to", "in today's landscape"
- No em-dash asides.
- No tricolons in every paragraph (the "X, Y, and Z" rhythm on repeat is the biggest AI tell).
- No "I hope this finds you well."
- No summarizing what I just said in the closing line.

## Register matrix
| Audience | Register |
|---|---|
| Close colleague | Informal, fragments fine, jokes fine |
| Recruiter / hiring manager | Warm, direct, specific. Lead with why I'm relevant. |
| Executive | Tight. Point first, evidence second, ask third. |
| Public post | Structured but still human. No thought-leader voice. |
...
> change at Cipherworks last year; signups went from 31% to 45% over three quarters, and it took a two-week
> A/B test to win the argument.
>
