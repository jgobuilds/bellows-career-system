...
def employer_claim_warnings(spec, profile_text=None):
    ...
    WHY THIS EXISTS: on 2026-07-24 an Optimum bullet claimed "Google Cloud, dbt Cloud,
    and Snowflake-class warehousing". Optimum is BigQuery/GCP; the profile's Optimum
    tool line has no Snowflake in it. The claim was also gratuitous — Snowflake is
    genuinely his at Upright, Brightside, and The Hartford — so nothing was gained by
